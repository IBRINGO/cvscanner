...
# ---------------------------------------------------------------------------
# Embeddings (Phase 3, extended in Phase 4) - optional. Absence of both
# API keys is not an error; config/container.py falls back to
# FakeEmbeddingProvider (deterministic, no network) whenever neither
# GEMINI_API_KEY nor OPENAI_API_KEY is set. Gemini is the primary
# provider, OpenAI the fallback - see docs/architecture/phase-4-matching.md
# and infrastructure/embeddings/.
# ---------------------------------------------------------------------------
